...
IB_ALL_PACKAGES="$IB_ALL_PACKAGES libibumad libibumad-devel libibumad-debuginfo"
IB_ALL_PACKAGES="$IB_ALL_PACKAGES libibmad libibmad-devel libibmad-debuginfo"
